...
class ControllerPaymentPagseguro extends Controller {
	...
	public function index() {
		...
		$this->data['entry_acrescimo'] = $this->language->get('entry_acrescimo');
		...
		if (isset($this->request->post['pagseguro_acrescimo'])) {
			$this->data['pagseguro_acrescimo'] = $this->request->post['pagseguro_acrescimo'];
		} else {
			$this->data['pagseguro_acrescimo'] = $this->config->get('pagseguro_acrescimo');
		}
	...
	private function validate() {
		...
		if ($this->request->post['pagseguro_acrescimo']) {
		  $this->request->post['pagseguro_acrescimo'] = (float)str_replace(',', '.', $this->request->post['pagseguro_acrescimo']);
		}
