...
class ControllerPaymentPagseguro extends Controller {
 	protected function index() {
		...
		$acrescimo = $this->config->get('pagseguro_acrescimo');
		$total = $this->currency->format($order_info['total'] * (1 + $acrescimo / 100) - $this->cart->getSubTotal(), $order_info['currency_code'], false, false);
