...
$codigocedente = $dadosboleto["codigocedente"];
...
//Guarda inicial
?><img src=boleto/boleto/imagens/p.png width=<?php echo $fino?> height=<?php echo $altura?> border=0><img 
src=boleto/boleto/imagens/b.png width=<?php echo $fino?> height=<?php echo $altura?> border=0><img 
src=boleto/boleto/imagens/p.png width=<?php echo $fino?> height=<?php echo $altura?> border=0><img 
